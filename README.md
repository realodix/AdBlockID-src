<p align="center"><img width="200" height="200" alt="Logo" src="/art/logo.png" /></p>

<h1 align="center">AdBlockID Source</h1>

<p align="right">
<a href="https://github.com/realodix/AdBlockID-src/commits/main"><img src="https://img.shields.io/github/commit-activity/m/realodix/AdBlockID?label=Commits&style=flat-square"></a>
...
This repository (`realodix/AdBlockID-src`) is for AdBlockID's development only. Head to [`realodix/AdBlockID`](https://github.com/realodix/AdBlockID) for the main README, or to [create an issue](https://github.com/realodix/AdBlockID/issues/new/choose).
